  ...
  const notifications = [
    {
      ...
      message: "Track your projects, manage tasks, and monitor performance all in one place.",
      time: "2 hours ago"
    },
    {
      id: 2,
      title: "New Feature Update",
      message: "We've added enhanced analytics and reporting features to help you make better decisions.",
      time: "1 day ago"
    },
    {
      id: 3,
      title: "Performance Tip",
      message: "Your task completion rate has improved by 15% this month. Keep up the great work!",
      time: "3 days ago"
    }
  ];
  ...
  return (
    <div className="flex items-center justify-between p-4 lg:p-6">
      <div className="flex items-center gap-3 lg:gap-4">
        ...
        <h1 className="text-xl lg:text-2xl font-bold text-foreground">Relient</h1>
        ...
        <Dialog open={feedbackOpen} onOpenChange={setFeedbackOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                We'd love to hear your thoughts! Help us improve your dashboard experience.
              </DialogDescription>
            </DialogHeader>
