...
export default function Home() {
  return (
    <div className="w-full min-h-screen overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 text-center">
        <div className="text-[#989898]">
          <p className="font-semibold mb-3 text-zinc-700 dark:text-[#cbcbcb]">Company</p>
          <p className="hover:underline cursor-pointer">About</p>
          <p className="hover:underline cursor-pointer">Careers</p>
          <p className="hover:underline cursor-pointer">Contact</p>
        </div>
        <div className="text-[#989898]">
          <p className="font-semibold mb-3 text-zinc-700 dark:text-[#cbcbcb]">Product</p>
        ...
        <div className="text-[#989898]">
          <p className="font-semibold mb-3 text-zinc-700 dark:text-[#cbcbcb]">Resources</p>
        ...
        <div className="text-[#989898]">
          <p className="font-semibold mb-3 text-zinc-700 dark:text-[#cbcbcb]">Legal</p>
    ...
    Built by <Link href="https://x.com/sashi_does" target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-zinc-800 dark:hover:text-[#98ddff] text-white">@sashi_does</Link>
  </p>
    </footer>
    </div>
  );
